...
map_keys("n", "x", '"_x', opts)

-- increment/decrement numbers
map_keys("n", "<leader>+", "<C-a>", opts) -- increment
map_keys("n", "<leader>-", "<C-x>", opts) -- decrement

-- toggle :ZenMode with leader + zm (zen mode)
map_keys("n", "<leader>zm", ":ZenMode<CR>", opts)
